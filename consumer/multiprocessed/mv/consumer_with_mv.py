...
def consume(i):
    ...
    cmd = 'mv ' + CONF['common']['BASE_PATH'] + i + '*' + ' ' + '/home/ubuntu/ephemeral/data/'
    #print(cmd)
    for _ in range(1):
        ...
        write_to_disk(file_names, file_contents, CONF['common']['BASE_PATH']+i, data_contains_split_key)
        os.system(cmd)
...
if __name__ == "__main__":
    ...
    #consume()
    Parallel(n_jobs=CONF['common']['MAX_NUMBER_OF_PROCESSES_EXECUTING_AT_A_TIME'])(delayed(consume)(i) for i in range(CONF['common']['PROCESS_POOL_SIZE']))

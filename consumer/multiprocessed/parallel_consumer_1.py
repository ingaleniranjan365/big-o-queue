...
def consume():
    ...
    for _ in range(1):    
        ...
        read_from_socket(CONF['common']['SERVER_ADDRESS'], CONF['consumer_1']['SERVER_PORT_FOR_FILE_NAMES'], CONF['consumer_1']['SERVER_PORT_FOR_FILE_CONTENTS'], file_name_chunks, file_content_chunks)

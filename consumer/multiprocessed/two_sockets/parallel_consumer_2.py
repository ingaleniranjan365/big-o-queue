...
def consume():
    for _ in range(1):
        all_file_name_chunks, all_file_content_chunks = read_from_socket(CONF['common']['SERVER_ADDRESS'], CONF['consumer_2']['SERVER_PORT_FOR_FILE_NAMES'], CONF['consumer_1']['SERVER_PORT_FOR_FILE_CONTENTS'])
...
if __name__ == "__main__":
    ...
    #consume()
    Parallel(n_jobs=CONF['common']['MAX_NUMBER_OF_PROCESSES_EXECUTING_AT_A_TIME'])(delayed(consume)() for i in range(CONF['common']['PROCESS_POOL_SIZE']))

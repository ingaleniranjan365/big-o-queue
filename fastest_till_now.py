...
def process_before_writing(file_name_chunks, file_content_chunks, file_names, file_contents):
    global done_reading_data
    global done_processing_data
    while not (done_reading_data and file_name_chunks.empty() and file_content_chunks.empty()):
...
if __name__ == "__main__":
    ...
    # consume()
    Parallel(n_jobs=2)(delayed(consume)() for _ in range(49))
    # Parallel(n_jobs=2)(delayed(consume)() for _ in range(1600))
